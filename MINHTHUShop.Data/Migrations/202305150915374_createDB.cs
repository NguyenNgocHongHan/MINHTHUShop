namespace MINHTHUShop.Data.Migrations
{
    ...
    public partial class createDB : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                "dbo.ApplicationStaffRoles",
                c => new
                    {
                        UserId = c.String(nullable: false, maxLength: 128),
                        RoleId = c.String(nullable: false, maxLength: 128),
                        IdentityRole_Id = c.String(maxLength: 128),
                        Tb_Staff_Id = c.String(maxLength: 128),
                    })
                .PrimaryKey(t => new { t.UserId, t.RoleId })
                .ForeignKey("dbo.ApplicationRoles", t => t.IdentityRole_Id)
                .ForeignKey("dbo.Tb_Staff", t => t.Tb_Staff_Id)
                .Index(t => t.IdentityRole_Id)
                .Index(t => t.Tb_Staff_Id);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.ApplicationStaffRoles", "Tb_Staff_Id", "dbo.Tb_Staff");
            DropForeignKey("dbo.ApplicationStaffLogins", "Tb_Staff_Id", "dbo.Tb_Staff");
            DropForeignKey("dbo.ApplicationStaffClaims", "Tb_Staff_Id", "dbo.Tb_Staff");
            ...
            DropForeignKey("dbo.ApplicationStaffRoles", "IdentityRole_Id", "dbo.ApplicationRoles");
            ...
            DropIndex("dbo.ApplicationStaffLogins", new[] { "Tb_Staff_Id" });
            DropIndex("dbo.ApplicationStaffClaims", new[] { "Tb_Staff_Id" });
            ...
            DropIndex("dbo.ApplicationStaffRoles", new[] { "Tb_Staff_Id" });
            DropIndex("dbo.ApplicationStaffRoles", new[] { "IdentityRole_Id" });
            ...
            DropTable("dbo.ApplicationStaffLogins");
            DropTable("dbo.ApplicationStaffClaims");
            ...
            DropTable("dbo.ApplicationStaffRoles");
