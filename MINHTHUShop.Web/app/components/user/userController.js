(function (app) {
    ...
    userController.$inject = ['$scope', '$ngBootbox', '$filter', 'apiService', 'notificationService'];

    function userController($scope, $ngBootbox, $filter, apiService, notificationService) {
        $scope.loading = true;
        $scope.user = [];
